...
class _$AppUser extends AppUser {
  ...
  _$AppUser._({this.uid, this.email, this.username, this.searchIndex, this.photoUrl}) : super._() {
    if (uid == null) {
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc($jc($jc(0, uid.hashCode), email.hashCode), username.hashCode), searchIndex.hashCode),
        photoUrl.hashCode));
  }
...
class AppUserBuilder implements Builder<AppUser, AppUserBuilder> {
  ...
  _$AppUser build() {
    ...
    try {
      _$result = _$v ??
          new _$AppUser._(
              uid: uid, email: email, username: username, searchIndex: searchIndex.build(), photoUrl: photoUrl);
    } catch (_) {
...
class _$RegistrationInfo extends RegistrationInfo {
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, email.hashCode), password.hashCode), username.hashCode));
  }
...
class RegistrationInfoBuilder implements Builder<RegistrationInfo, RegistrationInfoBuilder> {
  ...
  _$RegistrationInfo build() {
    final _$result = _$v ?? new _$RegistrationInfo._(email: email, password: password, username: username);
    replace(_$result);
    return _$result;
  }
}
