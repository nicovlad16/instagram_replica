...
// ignore: unused_element
  CreatePost$ call({void Function(AppAction) response}) {
    return CreatePost$(
      response: response,
    );
  }
...
class _$CreatePost$ implements CreatePost$ {
  const _$CreatePost$({this.response});
  ...
  @override
  String toString() {
    return 'CreatePost(response: $response)';
  }
...
abstract class CreatePost$ implements CreatePost {
  const factory CreatePost$({void Function(AppAction) response}) = _$CreatePost$;
...
class _$UpdatePostInfo$ implements UpdatePostInfo$ {
  ...
  @override
  String toString() {
    return 'UpdatePostInfo(addImage: $addImage, removeImage: $removeImage, description: $description, longitude: $longitude, latitude: $latitude, addUser: $addUser, removeUser: $removeUser)';
  }
